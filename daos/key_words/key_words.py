...
def load_key_words_ingred():
    ...
    with open('C:\\Users\\user\\PycharmProjects\\RecipeGrabberGev\\daos\\key_words\\resource\\key_words_ingri.txt', encoding="utf8") as f:
        key_words_ingred = [line.replace('\n', "") for line in f.readlines()]


def load_key_words_instr():
    global key_words_instr
    with open('C:\\Users\\user\\PycharmProjects\\RecipeGrabberGev\\daos\\key_words\\resource\\key_words_instruc.txt', encoding="utf8") as f:
