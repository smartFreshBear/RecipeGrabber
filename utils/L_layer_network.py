...
def two_layer_model(X, Y, layers_dims, learning_rate=0.0075, num_iterations=3000, print_cost=False):
    ...
    for i in range(0, num_iterations):
        ...
        parameters = core.update_parameters(parameters, grads, learning_rate)
        ### END CODE HERE ###
...
def L_layer_model(X, Y, layers_dims, learning_rate=0.0075, num_iterations=3000, print_cost=False, plot=False):
    """
    ...
    for i in range(0, num_iterations):
        ...
        AL, caches = core.L_model_forward(X, parameters)
        ### END CODE HERE ###

        # Compute cost.
        ### START CODE HERE ### (≈ 1 line of code)
        cost = core.compute_cost(AL, Y)
        ### END CODE HERE ###

        # Backward propagation.
        ### START CODE HERE ### (≈ 1 line of code)
        grads = core.L_model_backward(AL, Y, caches)
        ### END CODE HERE ###
